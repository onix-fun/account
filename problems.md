...
4. **Публичное определение существования аккаунтов**
    ...
    - [AuthService.kt](/account/account/backend/src/main/kotlin/profile/auth/AuthService.kt:321)
...
5. **Небезопасные production-значения по умолчанию**
    ...
    - [docker-compose.yml](/account/account/examples/docker-compose/docker-compose.yml:47)
...
6. **Удаление аккаунта не удаляет аватар**
    ...
    - [AuthService.kt](/account/account/backend/src/main/kotlin/profile/auth/AuthService.kt:201)
...
7. **Время жизни регистрационного кода не соответствует интерфейсу**
    ...
    - [application.yaml](/account/account/backend/src/main/resources/application.yaml:31)
...
8. **Нет backend-валидации полей профиля**
    ...
    - [UserService.kt](/account/account/backend/src/main/kotlin/profile/users/UserService.kt:18)

9. **Проверка попыток регистрационного кода не атомарна**
    - Параллельные запросы могут обойти лимит попыток.
    - [PendingRegistrationStore.kt](/account/account/backend/src/main/kotlin/profile/infrastructure/redis/PendingRegistrationStore.kt:127)
...
10. **Возможен DoS конкретного аккаунта**
    ...
    - [AuthService.kt](/account/account/backend/src/main/kotlin/profile/auth/AuthService.kt:221)
...
11. **Health checks ничего реально не проверяют**
    ...
    - [App.kt](/account/account/backend/src/main/kotlin/profile/App.kt:372)
...
12. **OpenAPI публично доступен даже при отключённом Swagger**
    ...
    - [nginx.conf.template](/account/account/gateway/nginx.conf.template:121)
...
13. **Gateway-тесты сломаны**
    ...
    - [test_session_status.lua](/account/account/gateway/tests/test_session_status.lua:25)
