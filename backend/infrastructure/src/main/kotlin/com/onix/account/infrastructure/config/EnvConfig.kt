...
object EnvConfig {
    ...
    fun load(env: Map<String, String> = System.getenv(), roleOverride: String? = null): MapApplicationConfig {
        ...
        put("identity.jwt.issuer", value("ACCOUNT_JWT_ISSUER", "account"))
        ...
        put("downstream.profile.target", value("ACCOUNT_PROFILE_GRPC_TARGET"))
        put("downstream.profile.api_key", value("ACCOUNT_PROFILE_API_KEY", secret = true))
        put("downstream.media.target", value("ACCOUNT_MEDIA_GRPC_TARGET"))
        put("downstream.media.api_key", value("ACCOUNT_MEDIA_API_KEY", secret = true))
