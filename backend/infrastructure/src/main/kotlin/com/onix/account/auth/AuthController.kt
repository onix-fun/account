...
import com.onix.account.infrastructure.security.TrustedProxy
import com.onix.account.shared.ApiErrorCode
import com.onix.account.shared.apiError
import com.onix.account.organizations.SwitchOwnerRequest
import com.onix.account.users.toProfileDto
...
class AuthController(
    ...
    private val sessionConfig: com.onix.account.infrastructure.config.SessionConfig,
    private val jwtConfig: JwtConfig,
    private val securityConfig: com.onix.account.infrastructure.config.SecurityConfig
) {
